...
var pointsOfInterest = [
    ...
    { name: "Broken Branch", coords: [1113, 593], description: "The Broken Branch is a river in the southeastern lands of the north. The headwaters of the Broken Branch lie in the Sheepshead Hills, while Ramsgate sits at its mouth, near where the Bite meets the Shivering Sea and the narrow sea.  <br>"  + '<a href="https://awoiaf.westeros.org/index.php/Broken_Branch" target="_blank">Learn More</a>' },
